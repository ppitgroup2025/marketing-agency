...
const services = [
  {
    ...
    features: ["Design & UX", "Brand Identity", "Content Strategy"],
  ...
  },
  {
    ...
    features: ["SEO & SEM", "Media Buying", "Social Media Marketing"],
  ...
  },
  {
    ...
    features: ["React/Next.js Web Dev", "CMS Development", "Digital Transformation"],
